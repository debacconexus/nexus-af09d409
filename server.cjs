...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "SecureGuard Incident & Vulnerability Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "security_incident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "security_incident_records";
'use strict';
